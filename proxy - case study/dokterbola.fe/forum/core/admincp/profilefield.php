...
define('CVS_REVISION', '$RCSfile$ - $Revision: 86264 $');
...
if ($_REQUEST['do'] == 'modifycheckbox')
{
	...
	if ($boxdata['data'] != '')
	{
		...
		foreach ($data AS $index => $value)
		{
			...
			if ($index != 1)
			{
				$moveup = "<a href=\"admincp/profilefield.php?" . vB::getCurrentSession()->get('sessionurl') . "profilefieldid=" . $vbulletin->GPC['profilefieldid'] . "&do=movecheckbox&direction=up&id=$index\"><img src=\"' . $vbulletin->options['bburl'] . '/cpstyles/" . $vbulletin->options['cpstylefolder'] . "/move_up.gif\" border=\"0\" /></a> ";
			}
			else
			{
			...
			{
				$movedown = "<a href=\"admincp/profilefield.php?" . vB::getCurrentSession()->get('sessionurl') . "profilefieldid=" . $vbulletin->GPC['profilefieldid'] . "&do=movecheckbox&direction=down&id=$index\"><img src=\"' . $vbulletin->options['bburl'] . '/cpstyles/" . $vbulletin->options['cpstylefolder'] . "/move_down.gif\" border=\"0\" /></a> ";
			}
			else
			{
				unset($movedown);
