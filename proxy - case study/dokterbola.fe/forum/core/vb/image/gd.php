...
class vB_Image_GD extends vB_Image
{
	...
	*/
	...
	protected function orientImageInternal($fileContents, $location, $orientation, $newfile)
	{
		...
		$image = imagerotate($image, $angles, 0);
		...
		/*
			TODO: Maintain exif data other than 'orientation'
		 */

		// jpeg quality is set to 100 as we don't want to downsample, we want to maintain the original quality while rotating/flipping
		$extension = $this->printImage($image, $imageinfo[2], false, 100, $newfile);
