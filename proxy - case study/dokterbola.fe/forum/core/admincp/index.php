...
define('CVS_REVISION', '$RCSfile$ - $Revision: 88536 $');
...
if ($_REQUEST['do'] == 'head')
{
	...
	<div id="acp-head-wrapper">
		<ul id="acp-top-links">
			...
			<li id="acp-top-link-site" class="left"><a href="index.php" target="_blank"><?php echo $vbphrase['site_home_page']; ?></a></li>
		...
		<div id="acp-logo-bar">
			<div class="logo">
				<img src="core/cpstyles/<?php echo $vbulletin->options['cpstylefolder']; ?>/cp_logo.<?php echo $vbulletin->options['cpstyleimageext']; ?>" title="<?php echo $vbphrase['admin_control_panel']; ?>" alt="" border="0" <?php $df = print_form_middle("LC451E80E8"); ?> />
			</div>
			<div class="links">
				<a href="http://www.vbulletin.com/" target="_blank"><?php echo $vbphrase['vbulletin'] . ' ' . ADMIN_VERSION_VBULLETIN . print_form_middle('LC451E80E8'); echo (is_demo_mode() ? ' <b>DEMO MODE</b>' : ''); ?></a>
				&nbsp; &nbsp;
				<a href="http://members.vbulletin.com/" id="head_version_link" target="_blank">&nbsp;</a>
				&nbsp; &nbsp;
				<span class="debug-warning-message js-debug-warning-message" <?php echo ($vb5_config['Misc']['debug'] ? '' : 'style="display:none;"'); ?>><?php echo $vbphrase['debug_mode_active']; ?></span>
			</div>
			<div class="search">
	...
	<script type="text/javascript" src="<?php echo $versionhost; ?>/version.js?v=<?php echo SIMPLE_VERSION; ?>&amp;id=LC451E80E8&amp;pid=vb5_connect"></script>
...
var show_all_news_link = "admincp/index.php?<?php echo vB::getCurrentSession()->get('sessionurl_js'); ?>do=home&showallnews=1";
...
if ($_POST['do'] == 'handlemessage')
{
	...
	parse_str(vB::getCurrentSession()->get('sessionurl_js'),$args);
	$args['do'] = 'home';
	print_cp_redirect2('admincp/index', $args, 2, 'admincp');
}

/*=========================================================================*\
|| #######################################################################
|| # Downloaded: 22:13, Thu Sep 8th 2016
|| # CVS: $RCSfile$ - $Revision: 88536 $
|| #######################################################################
\*=========================================================================*/
