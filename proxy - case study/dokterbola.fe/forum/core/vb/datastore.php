 ...
 *
 * @package	vBulletin
 * @version	$Revision: 88806 $
 * @date		$Date: 2016-05-24 16:34:59 -0700 (Tue, 24 May 2016) $
 */
class vB_Datastore
{
	...
	*/
	...
	public function buildUserGroupCache($usergroupinfo)
	{
		...
		// upgrade classes may pass in a usergroup db fetch result array rather than an array keyed by usergroup that permissioncontext expects. VBV-16058
		$keyedArray = array();
		...
		$this->registered['usergroupcache'] = $keyedArray;
		return $keyedArray;
	}
}
