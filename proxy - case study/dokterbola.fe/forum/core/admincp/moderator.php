	...
	if (count($moderators))
	{
		...
		foreach ($moderators AS $moderator)
		{
			if ($curmod != $moderator['userid'])
			{
				...
				echo "\n\t<ul>\n\t<li><b><a href=\"admincp/user.php?" . vB::getCurrentSession()->get('sessionurl') . "do=edit&amp;u=$moderator[userid]&amp;redir=showlist\">$moderator[username]</a></b><span class=\"smallfont\"> - " . $vbphrase['last_online'] . " <span class=\"$onlinecolor\">" . $lastonline . "</span></span>\n";
	...
	if (count($channels))
	{
		foreach ($channels AS $channel)
		{
			...
			if ($curnode != $channel['nodeid'])
			{
				...
				echo "\n\t<ul>\n\t<li><b><a href=\"" . fetch_seo_url('forum|bburl', $channel) . "\">$channel[htmltitle]</a></b>\n";
			...
			echo "\t\t\t<li><a href=\"admincp/user.php?" . vB::getCurrentSession()->get('sessionurl') . "do=edit&amp;u=$channel[userid]\" target=\"_blank\">$channel[username]</a>" .
