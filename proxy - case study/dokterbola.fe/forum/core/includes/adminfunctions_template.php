...
function process_css_rollup_file($file, $templatelist, $templates, $styleid, $styledir, &$vbdefaultcss = array())
{
...
function construct_color_picker($size = 12, $display = 'none')
{
	...
	<tr>
		<td><button onclick=\"col_click('transparent'); return false\"><img src=\"core/cpstyles/" . $vbulletin->options['cpstylefolder'] . "/colorpicker_transparent.gif\" title=\"'transparent'\" alt=\"\" /></button></td>
		<td>
		...
		<td style=\"white-space:nowrap\">
			...
			<button onclick=\"switch_color_picker(1); return false\"><img src=\"core/cpstyles/" . $vbulletin->options['cpstylefolder'] . "/colorpicker_toggle.gif\" alt=\"\" /></button>
			<button onclick=\"close_color_picker(); return false\"><img src=\"core/cpstyles/" . $vbulletin->options['cpstylefolder'] . "/colorpicker_close.gif\" alt=\"\" /></button>
		</td>
	</tr>
	</table>
...
function activateCodeMirrorPHP($ids)
{
	...
	?>
				...
				<script src="core/clientscript/codemirror/addon/edit/closetag.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="core/clientscript/codemirror/addon/hint/show-hint.js?v=<?php echo SIMPLE_VERSION ?>"></script>
				<script src="core/clientscript/codemirror/addon/hint/php-hint.js?v=<?php echo SIMPLE_VERSION ?>"></script>
			<script type="text/javascript">
			<!--
			window.onload = function() {
				$(["<?php echo implode('","', $ids)?>"]).each(function(){
