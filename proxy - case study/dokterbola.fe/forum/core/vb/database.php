...
*
* @package	vBulletin
* @version	$Revision: 89155 $
* @date		$Date: 2016-06-23 08:45:29 -0700 (Thu, 23 Jun 2016) $
*/
abstract class vB_Database
{
	...
	*/
	...
	public function create_database_using_dbconfig()
	{
		...
		$query = "CREATE DATABASE " . $useconfig['Database']['dbname'];
		if(isset($useconfig['Mysqli']['charset']))
		{
			...
			$query .= " CHARACTER SET '" . $this->escape_string($useconfig['Mysqli']['charset']) . "'";
		}
