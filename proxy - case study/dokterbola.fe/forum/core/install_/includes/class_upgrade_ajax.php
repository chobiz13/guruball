...
class vB_Upgrade_Ajax extends vB_Upgrade_Abstract
{
	...
	*/
	protected function init($script, $process = true)
	{
		vB::silentWarnings();
		parent::init($script);
		$this->custnumber = (strlen('be8498c371158ece3c593f4c56fefc6b') == 32) ? 'be8498c371158ece3c593f4c56fefc6b' : md5(strtoupper('be8498c371158ece3c593f4c56fefc6b'));
