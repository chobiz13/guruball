		...
		selectBox: function(method, data) {
			...
			var init = function(select, data) {
				...
				if( inline ) {
					...
					//added for vBulletin
					//moved setting of width here and considered font size to get more accurate select width
					control.width(select.css('fontSize', control.css('fontSize')).width()) - parseInt(control.css('border-left-width'), 10) - parseInt(control.css('border-right-width'), 10);
				...
				var option = $('.selectBox-label', control);
				var adjustmentWidth = parseInt(option.css('paddingLeft')) - 4 + parseInt(option.css('paddingRight'));
				var controlWidth = control.width() + adjustmentWidth;
