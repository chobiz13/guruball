...
class vB_Api_UserGroup extends vB_Api
{
	...
	**/
	...
	public function save($usergroup, $ugid_base = 0, $usergroupid = 0)
	{
		...
		build_channel_permissions(); // build_channel_permissions() calls vB::getDatastore()->buildUserGroupCache() which builds the 'usergroupcache' datastore value
		build_birthdays();
