...
VALUES
	('gif', '"  . $db->escape_string(serialize(array('Content-type: image/gif')))                 . "', '900000', '1440', '900', '0', '" . $db->escape_string(serialize($contenttype_post + $contenttype_album_enabled + $contenttype_group_enabled)) . "'),
	('jpeg', '" . $db->escape_string(serialize(array('Content-type: image/jpeg')))                . "', '900000', '1440', '900', '0', '" . $db->escape_string(serialize($contenttype_post + $contenttype_album_enabled + $contenttype_group_enabled)) . "'),
	('jpg', '"  . $db->escape_string(serialize(array('Content-type: image/jpeg')))                . "', '900000', '1440', '900', '0', '" . $db->escape_string(serialize($contenttype_post + $contenttype_album_enabled + $contenttype_group_enabled)) . "'),
	('jpe', '"  . $db->escape_string(serialize(array('Content-type: image/jpeg')))                . "', '900000', '1440', '900', '0', '" . $db->escape_string(serialize($contenttype_post + $contenttype_album_enabled + $contenttype_group_enabled)) . "'),
	('txt', '"  . $db->escape_string(serialize(array('Content-type: text/plain')))                . "', '900000', '0', '0', '2', '"      . $db->escape_string(serialize($contenttype_post + $contenttype_album_disabled + $contenttype_group_disabled)) . "'),
	('png', '"  . $db->escape_string(serialize(array('Content-type: image/png')))                 . "', '900000', '1440', '900', '0', '" . $db->escape_string(serialize($contenttype_post + $contenttype_album_enabled + $contenttype_group_enabled)) . "'),
	('doc', '"  . $db->escape_string(serialize(array('Content-type: application/msword')))        . "', '900000', '0', '0', '0', '"      . $db->escape_string(serialize($contenttype_post + $contenttype_album_disabled + $contenttype_group_disabled)) . "'),
	('pdf', '"  . $db->escape_string(serialize(array('Content-type: application/pdf')))           . "', '900000', '0', '0', '0', '"      . $db->escape_string(serialize($contenttype_post + $contenttype_album_disabled + $contenttype_group_disabled)) . "'),
	('psd', '"  . $db->escape_string(serialize(array('Content-type: image/vnd.adobe.photoshop'))) . "', '900000', '0', '0', '0', '"      . $db->escape_string(serialize($contenttype_post + $contenttype_album_disabled + $contenttype_group_disabled)) . "'),
	('zip', '"  . $db->escape_string(serialize(array('Content-type: application/zip')))           . "', '900000', '0', '0', '0', '"      . $db->escape_string(serialize($contenttype_post + $contenttype_album_disabled + $contenttype_group_disabled)) . "')
";
