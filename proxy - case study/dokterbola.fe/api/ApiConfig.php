...
class ApiConfig
{
     ...
     * @var string
     */
    private $uniqueName = "dokterbola";

    /**
     * @var string
     */
    private $clientName = "dokterbola";

    /**
     * @var string
     */
    private $clientVersion = "1.1";

    /**
     * @var string
     */
    private $platformName ="dokterbola";

    /**
     * @var string
     */
    private $platformVersion = "1.1";
     ...
     * @var int
     */
    private $clientId = "4521";

    /**
     * @var string
     */
    private $apiKey = "rrrrrr8r";
