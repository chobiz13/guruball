	...
	if (VB_AREA == 'AdminCP')
	{
		...
		<tr>
			...
			<td align=\"" . vB_Template_Runtime::fetchStyleVar('right') . "\">
				...
				><img class=\"acp-nav-arrow\" src=\"core/cpstyles/" . $vb_options['cpstylefolder'] . "/cp_$dowhat." . $vb_options['cpstyleimageext'] . "\" title=\"$tooltip\" id=\"button_{$nav_file}_$groupid[$nav_file]\" alt=\"+\" border=\"0\" /></a>
			</td>
		</tr>
		</table>";
		$_NAV .= "
...
?>
	...
	function open_close_group(group, doOpen)
	{
		...
		else
		{
			...
			curbtn.src = "core/cpstyles/<?php echo $vbulletin->options['cpstylefolder']; ?>/cp_expand.<?php echo $vbulletin->options['cpstyleimageext']; ?>";
