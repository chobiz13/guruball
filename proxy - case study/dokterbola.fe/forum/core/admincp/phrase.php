...
define('CVS_REVISION', '$RCSfile$ - $Revision: 87816 $');
...
if ($_POST['do'] == 'doreplace')
{
	...
	parse_str(vB::getCurrentSession()->get('sessionurl'),$args);
	$args['do'] = 'rebuild';
	$args['goto'] = urlencode("admincp/phrase.php?" . vB::getCurrentSession()->get('sessionurl') . "do=search");
	exec_header_redirect2('language', $args);
}
