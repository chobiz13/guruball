...
define('CVS_REVISION', '$RCSfile$ - $Revision: 86249 $');
...
if ($_REQUEST['do'] == 'head')
{
	...
	// TODO: Should this point to just root/index.php instead, like the site_home_page link in admincp?
	$forumHome = vB_Library::instance('content_channel')->getForumHomeChannel();
	$forumhomelink = vB5_Route::buildUrl($forumHome['routeid'] . '|fullurl');
?>
